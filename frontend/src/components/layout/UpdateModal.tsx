    ...
    const footer = (
        <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex gap-2">
                <Button variant="ghost" className="h-11 rounded-2xl px-6 text-[13px]" onClick={onClose}>
                    Later
                </Button>
                <Button className="flex h-11 gap-2 rounded-2xl bg-success px-8 text-[13px] font-bold text-white hover:bg-success/90" onClick={handleDownload}>
                    <Download size={16} />
                    Download Now
                </Button>
            </div>
    ...
    return (
        <ModalBackdrop onClose={onClose} contentClassName="flex w-full items-center justify-center p-3">
            <ModalFrame
                ...
                onClose={onClose}
                footer={footer}
                className="w-[500px] max-w-[calc(100vw-24px)] max-h-[85vh] rounded-[32px] border border-border/10 shadow-elevation-lg"
