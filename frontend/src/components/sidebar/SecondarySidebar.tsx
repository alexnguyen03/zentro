                            ...
                            {panels.map((panel) => {
                                ...
                                return (
                                    <TabsTrigger
                                        key={panel.id}
                                        value={panel.id}
                                        className="relative h-8 rounded-sm cursor-pointer bg-transparent px-2.5 text-muted-foreground shadow-none transition-colors hover:text-foreground data-[state=active]:bg-(--state-selected-bg) data-[state=active]:text-[var(--state-selected-text)] data-[state=active]:shadow-none"
                                        title={panel.label}
